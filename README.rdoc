...
Copyright (C) 2009 - 2013 Christopher Mann <christopher@mann.fr> (see also CREDITS.rdoc)
...
Many steps were manual in the first version. Today, the i dea is to automate parts of the use of Taskjuggler from Redmine, and to update Redmine from Taskjuggler. Here is the current workflow:
