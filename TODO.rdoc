...
* Migrate custom-fields to own data model
  * Augment Issues, Projects, Ressources rendering links polymorphic
  * Add fields to issue views
* Update to Taskjuggler 3 from Taskjuggler 2
* Update to Redmine 2 from Redmine 0.8
* Ease installation
...
Initially used for a 22-person IT department in Redmine v.0.9 and Taskjuggler v.2, today this update is for a 4-person development team in Redmine v2.X and Taskjuggler v.3.
